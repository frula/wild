...
-- Volcando estructura de base de datos para pizzeria2
CREATE DATABASE IF NOT EXISTS `pizzeria2` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `pizzeria2`;


-- Volcando estructura para tabla pizzeria2.categoria
...
-- Volcando datos para la tabla pizzeria2.categoria: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla pizzeria2.cliente
...
-- Volcando datos para la tabla pizzeria2.cliente: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla pizzeria2.combos
...
-- Volcando datos para la tabla pizzeria2.combos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `combos` DISABLE KEYS */;
/*!40000 ALTER TABLE `combos` ENABLE KEYS */;


-- Volcando estructura para tabla pizzeria2.detallepedido
...
-- Volcando datos para la tabla pizzeria2.detallepedido: ~11 rows (aproximadamente)
...
-- Volcando estructura para tabla pizzeria2.listaproveedor
...
-- Volcando datos para la tabla pizzeria2.listaproveedor: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla pizzeria2.materiaprima
...
-- Volcando datos para la tabla pizzeria2.materiaprima: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla pizzeria2.pedido
...
-- Volcando datos para la tabla pizzeria2.pedido: ~11 rows (aproximadamente)
...
-- Volcando estructura para tabla pizzeria2.producto
...
-- Volcando datos para la tabla pizzeria2.producto: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla pizzeria2.proveedor
...
-- Volcando datos para la tabla pizzeria2.proveedor: ~1 rows (aproximadamente)
...
-- Volcando estructura para tabla pizzeria2.repartidor
...
-- Volcando datos para la tabla pizzeria2.repartidor: ~0 rows (aproximadamente)
