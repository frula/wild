...
public class Pedido {
	...
	public Pedido(String numPed, Cliente clientePedido, String fechaPedido,
	  ...
	  public Pedido(String idPedido, String numPed,int cliente,
		...
		public Pedido(String id,String numPed, Cliente clientePedido, String fechaPedido,
				double totalPedido,int pagado, int Adomicilio,String estado) {
			...
			if(pagado==0){this.pagoConfirmado=false;}
			else{this.pagoConfirmado=true;
			}
		  ...
		  public Pedido(String idPedido, String numPed,int cliente,
					String fechaPedido, double totalPedido,int pagado,int Adomicilio,boolean itinerario,String estado) {
