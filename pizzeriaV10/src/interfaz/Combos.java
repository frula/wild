...
public class Combos {
	...
	private void initialize() {
		...
		frmCombos.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		...
		btnAgregar.setBounds(10, 64, 89, 23);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					for (int r = 0; r < productos.getRowCount(); r++) {
						...
						Basededatos
								.ejecutarsql("INSERT INTO detallecombo (IDCombo,Producto,Cantidad,Descripcion) VALUES ('"
										+ idProducPrincipal
										+ "', '"
										+ idProduc
										+ "', '"
		...
		lblCantidad.setBounds(236, 68, 60, 14);
		frmCombos.getContentPane().add(lblCantidad);

		cant = new JTextField();
		cant.setBounds(316, 65, 89, 20);
		...
		btnQuitar.setBounds(117, 64, 99, 23);
