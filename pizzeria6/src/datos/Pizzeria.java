		...
		try {
			lineas = Basededatos
					.consultasql("Select "
							...
							+ " detallepedido on pedido.IDPedido=detallepedido.IDPedido inner join producto on detallepedido.IDProducto=producto.IDProducto WHERE pedido.Preparado = 0 AND (producto.Categoria<>'LISTO') AND (producto.Categoria<>'COMBO')GROUP BY detallepedido.IDProducto ");
