...
-- Volcando datos para la tabla pizzeria.itinerario: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `itinerario` DISABLE KEYS */;
INSERT INTO `itinerario` (`IdItinerario`, `IdRepartidor`, `IdPedido`, `Fecha`) VALUES
	(5, 1, 101, '2015-11-02'),
	(6, 1, 103, '2015-11-02');
...
INSERT INTO `pedido` (`IDPedido`, `NumeroPedido`, `Cliente`, `FechaPedido`, `TotalPedido`, `Pagado`, `Preparado`, `Adomicilio`, `Itinerario`, `Estado`) VALUES
	...
	(104, 6, 1, '2015-10-22', 20, 0, 0, 1, NULL, 'No preparado'),
	(105, 7, 2, '2015-10-22', 60, 0, 0, 0, NULL, 'Entregado'),
	(106, 8, 2, '2015-10-22', 1360, 1, 0, 0, NULL, 'No preparado'),
	(107, 9, 2, '2015-10-22', 40, 0, 0, 0, NULL, 'Entregado'),
	(108, 10, 1, '2015-10-22', 20, 0, 0, 0, NULL, 'null'),
	(109, 11, 1, '2015-10-22', 40, 0, 0, 0, NULL, 'null'),
	(110, 12, 3, '2015-10-30', 300, 0, 0, 1, 0, 'null'),
